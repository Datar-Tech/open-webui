...
Modify package.json Line #2 for "version": "1.3.20"


- docker login
- change package.json line #2:	"version": "1.3.20",
- docker build --build-arg BUILD_HASH=v1.3.20 -t tech-sense .
- docker tag tech-sense deliah/tech-sense:v1.3.20
- docker push deliah/tech-sense:v1.3.20
- docker tag tech-sense deliah/tech-sense:latest
- docker push deliah/tech-sense:latest

git tag -a v1.3.20 -m "Release v1.3.20"
git push origin v1.3.20
git push origin --delete v1.3.20
